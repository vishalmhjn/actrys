...
def black_box_function(tls_tt_pen, 
    ...
    true_counts, simulated_counts, \
        _, _ = od_to_counts(pre_string +"/"+OD_FILE_IDENTIFIER+"_mean.txt",
                                                    best_od,
                                                    path_trips,
                                                    path_routes,
                                                    path_temp_additional,
    ...
    for seq in range(0, n_sequential):
        ...
        if eval(calibrate_demand): 
            ...
            if only_bias_correction:
                ...
                res_dict["od_val"].append(rmsn_od_bias_corrected)
                res_dict["f_val"].append(weight_od*rmsn_od_bias_corrected + weight_counts*rmsn_c)
        ...
        if eval(calibrate_supply):
            ...
            pbounds = {'rerouting_probability': (0.1, 0.9),
